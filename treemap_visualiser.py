...
if __name__ == '__main__':
    ...
    # run_treemap_file_system('/Users/yehuang/Desktop/csc148/assignments//'
    #                         'a2/example-directory/workshop')

    # To check your work for Task 6, try uncommenting the following
    # paper_t = PaperTree('CS1', [], all_papers=True, by_year=True)
    # paper_t.expand_all()
    # for sub in paper_t._subtrees:
    #     if sub._name == '2003':
    #         for s in sub._subtrees:
    #             if s._name == 'CA':
    #                 for i in s._subtrees:
    #                     if i._name == 'pair programming':
    #                         print(i.get_suffix())
    #                         for c in i._subtrees:
    #                             print(c._name)
    #                             print(c.get_suffix())
    #                             print(c._expanded)
    # run_treemap_papers()
